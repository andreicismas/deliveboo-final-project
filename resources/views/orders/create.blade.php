                        ...
                        <div class="border-box">
                            ...
                            <div class="counter-div">
                                <div class="tag-counter my-bttns">
                                    ...
                                    <input class="counter-display my-counter-input " name="dishes[{{ $dish->id }}]"
                                        {{-- colleziona gli esatti id che vanno sincronizzati anzichè tutti --}} type="number" placeholder="0">
